...
```
 # MONTHS_FREQUENCY_OF_CANCELED_BOOKINGS_IN_HOTELS  VISUALIZATION
...
# However months :1 and 2 are the most cost effective month.
# OTHER advantages of the CITY HOTEL are  :large scale business operations which 
# gurantee quality services ,and social adventure due to its high visitors diversity.